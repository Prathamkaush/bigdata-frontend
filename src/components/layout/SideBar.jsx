    ...
    <>
      ...
      >
        ...
        <nav className="space-y-2 flex-1">
          ...
          <div>
            ...
            {openUsers && (
              <div className="ml-6 mt-2 space-y-1">
                ...
                {/* Admin Only → Create Admin/Subadmin/Viewer */}
                {role === "admin" && (
                  <NavLink
                    to="/role/create"
                    className={({ isActive }) =>
                  ...
                  >
                    <UserPlus size={16} /> Create Admin / Sub Admin
                  </NavLink>
                )}
          ...
          {/* -------------------------------------- */}
          {/* CLICKHOUSE RECORDS (Completely Separate) */}
          {/* -------------------------------------- */}
          <NavLink
            to="/records"
            className={({ isActive }) =>
          ...
          >
            <Database size={20} /> Records (ClickHouse)
          </NavLink>
